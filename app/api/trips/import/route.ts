    ...
    for (let i = 0; i < dataRows.length; i++) {
      ...
      try {
        ...
        await createTrip({
          ...
          // Imported excursions default to each excursion's own library
          // setting — no per-excursion inclusion column in the template;
          // edit via the trip-form to override any of them per trip.
          excursion_inclusion: {},
